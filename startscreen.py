...
class StartScreen():
    ...
    def makeScreen(self, screen, gamesettings, game):
        ...
        titleredghost = Ghost(screen, "red")
        titleredghost.rect.x = -70
        titlecyanghost = Ghost(screen, "cyan")
        titlecyanghost.rect.x = -105
        titleorangeghost = Ghost(screen, "orange")
        titleorangeghost.rect.x = -140
        titlepinkghost = Ghost(screen, "pink")
